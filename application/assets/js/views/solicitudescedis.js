                    ...
                    swal({
                        ...
                        var arr={
                            ...
                            mensaje:'<h1>Cedis ha <b>Cancelado la solicitud</b> de traspaso folio #'+data.cabecera[0].folio+'</h1>\n\
                                    ...
                                    <br><b>Articulo:</b> '+data.cabecera[0].articulo+' enviado de '+data.cabecera[0].almacen+'\n\
                                    <br><b><label>Cantidad de venta:</b></label>'+data.detalle[0].cantidad+'\n\
                                    <br><b><label>Comentarios:</b></label><br>'+$('#swal-input2').val()+'\n\
                                    <br><label><b>Puede consultar en el siguiente enlace: </b></label><a href="http://inax.aytcloud.com/inax/public/solicitudescedis?id='+id+'">Consultar</a>',
           ...
           $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if(Number(data.cabecera[0].estatus)==1){
                        var arr={
                                titulo:"Estatus de solicitud de traspaso",
                                mensaje:'<h1>Cedis ha recibido la solicitud de traspaso folio #'+data.cabecera[0].folio+'</h1><br><label>puede consultar en el siguiente enlace: </label><a href="http://inax.aytcloud.com/inax/public/solicitudescedis?id='+id+'">Consultar</a>',
                    ...
                    if(Number(data.cabecera[0].estatus)==2){
                        swal({
                            title: 'Agregar comentario',
                            html:'<input id="swal-input1" name="comentarios" class="swal2-input" placeholder="COMENTARIOS">'+
                                 '<input id="swal-input4" class="swal2-input" placeholder="NUMERO DE SERIE">'+
                            ...
                            var arr={
                                ...
                                mensaje:'<h1>Cedis ha enviado la solicitud de traspaso folio #'+data.cabecera[0].folio+'</h1>\n\
                                        ...
                                        <br><b>Articulo:</b> '+data.cabecera[0].articulo+' enviado de '+data.cabecera[0].almacen+'\n\
                                        <br><b><label>Cantidad de venta:</b></label>'+data.detalle[0].cantidad+'\n\
                                        <br><b><label>Comentarios: &nbsp;</b></label>'+$('#swal-input1').val()+'<br><label><b>Tipo de Movimiento: &nbsp;</b></label>'+$('#swal-input3').val()+'\n\
                                        <br><b><label>Numero de serie: &nbsp;</b></label>'+$('#swal-input4').val()+'<br>'+'\n\
                                        <br><label><b>Puede consultar en el siguiente enlace: </b></label><a href="http://inax.aytcloud.com/inax/public/solicitudescedis?id='+id+'">Consultar</a>',
                                asunto:"Actualizacion de traspaso con folio #"+data.cabecera[0].folio+" de cliente: "+data.cabecera[0].cliente,
                                formato:"traspasosSolicitud.html",
                                type:2,
                    ...
                    if(Number(data.cabecera[0].estatus)==3){
                        var arr={
                                ...
                                mensaje:'<h1>Almacén Chihuahua ha registrado la solicitud de traspaso folio #'+data.cabecera[0].folio+'</h1><br>\n\
                                        ...
                                        <label>puede consultar en el siguiente enlace: </label><a href="http://inax.aytcloud.com/inax/public/solicitudescedis?id='+id+'">Consultar</a>',
                                asunto:"Actualizacion de traspaso con folio #"+data.cabecera[0].folio+" de cliente: "+data.cabecera[0].cliente,
                                formato:"traspasosSolicitud.html",
                                type:3,
                                cedis:usuario,
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            if(data=="enviado"){
                swal({
                    type: 'success',
                    html: 'Correo enviado favor de verificar en la bandeja de entrada de correo',
