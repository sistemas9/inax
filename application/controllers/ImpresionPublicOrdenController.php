...
class ImpresionPublicOrdenController extends Zend_Controller_Action{
        ...
        if ($flag) {
            ...
            $trBank = '
                ...
                <tr>
                    ...
                    <td style="width: 40%; font-size: 12px;">4944</td>
                    ...
                    <td style="width: 100%;">
                        <table  style="width: 100%" cellpading="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 40%; font-size: 12px; background-color: #BDBDBD">CONVENIO</td>
