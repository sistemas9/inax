...
class FallasinaxController extends Zend_Controller_Inax{
    ...
    public function filterTimeAction() {
        ...
        $totalWSDiarioError= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_E);
        $totalWSDiarioErrorC= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_EC);
        $totalWSDiarioErrorE= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_EE);
        ...
        $totalWSDiario= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_NEW);
        $totalWSDiarioCerrar= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_NEW_CERRAR);
        $totalWSDiarioEditar= $model->getCount($hoy2.' 00:00:00',$hoy.' 23:59:59',TOTAL_PETICIONES_WS_DIARIO_NEW_EDITAR);
        ...
        $this->json(
            array(
                ...
                "totalDiarioError"=>$totalWSDiarioError['total'],
                "totalDiarioErrorC"=>$totalWSDiarioErrorC['total'],
                "totalDiarioErrorE"=>$totalWSDiarioErrorE['total'],
                ...
                "totalWSDiario"=>$totalWSDiario['total'],
                "totalWSDiarioCerrar"=>$totalWSDiarioCerrar['total'],
                "totalWSDiarioEditar"=>$totalWSDiarioEditar['total'],
