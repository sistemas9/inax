...
class ConsultaguiaController extends Zend_Controller_Inax{
    ...
    public function getListAction() {
       ...
       // $model= new Application_Model_ConsultaguiaModel();
        $this->json(Application_Model_ConsultaguiaModel::getListByClient(array("cliente"=>  filter_input(INPUT_POST,'cliente'),"fecha"=>$date->format('Y-m-d'))));
    }
    
    public function getDetailFromOvAction() {
        //$model= new Application_Model_ConsultaguiaModel();
        $this->json(Application_Model_ConsultaguiaModel::getDetailFromOV(array("ov"=>  filter_input(INPUT_POST,'ov'))));
    }
}
